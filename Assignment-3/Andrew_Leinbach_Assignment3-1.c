...
int main(int argc, const char * argv[])
{
    ...
    /*queries processing*/
    temp2 = (char*)malloc(sizeof(char)*24);
    while (fgets(temp, 100, queries) != NULL) {
        ...
        if (strcmp(temp2,"LIST-MESSAGES-BY-DATE\n") == 0) {
        ...
        /*LIST-MESSAGES-FROM*/
        else if (strcmp(temp2,"LIST-MESSAGES-FROM") == 0) {
            temp2 = strtok(NULL, "\n");
        ...
        /*DISPLAY-MESSAGE*/
        else if (strcmp(temp2,"DISPLAY-MESSAGE") == 0) {
            temp2 = strtok(NULL, "\n");
            number = atoi(temp2);
        ...
        /*DELETE-LAST-MESSAGE*/
        else if (strcmp(temp2,"DELETE-LAST-MESSAGE\n") == 0) {
